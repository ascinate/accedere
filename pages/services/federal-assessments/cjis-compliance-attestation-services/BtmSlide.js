                ...
                <Slider {...settings}>
                  <div className="items-process1 d-md-flex align-items-center">
                     ...
                     <div className="content-part1">
                        ...
                        <p> After the agreement is executed, the first phase of the engagement is planning.
                         This is to ensure that Schellman and the Client are fully aware of the what, who, 
                        when, why, and how prior to the beginning of testing.
                        </p>
                       
                        <p> Proper planning is imperative to the success of a project. Schellman 
                        has standard processes to cover the important pieces of the engagement.</p> 
                     </div>
                  </div>
                  ...
                  <div className="items-process1 d-md-flex align-items-center">
                     ...
                     <div className="content-part1">
                        ...
                        <h6> Core CSP Activities </h6>
                        <p> The kickoff is considered the start of the engagement. If needed, Schellman will schedule a call at the beginning of, or just prior to, the kickoff to finalize any outstanding items.
                         Schellman will be available to the client with any questions.
                        </p>

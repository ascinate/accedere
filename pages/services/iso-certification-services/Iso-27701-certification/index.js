        ...
        <>
          ...
          <div className='contact-page-1 sub-page-body float-start w-100'>
                ...
                <div className="container">
                    ...
                    <h2 className="comon-head-main mt-4">Why ISO / IEC 27xxx</h2>
                    ...
                    <p>You may check and download the ISO 27001 checklist , ISO 27001 PDF Standard , 
                    costs for ISO 27001 Audits , ISO 27000 , 27001 ,27002 , 27010 , 27011 , 27017 , 27018 , 
                    27019 Audit Certification Process, ISO 27000 vs SOC , ISO 27001 Cloud Security challenges
                     and Cloud STAR Certification ,
                     C5 Cloud certification in our resources section</p> 


                     
                    <h2 className="comon-head-main mt-5">ISO 27701 : 2019-Privacy Information Management 
                    System (PIMS)</h2>

                    <p>  In August 2019, the ISO announced a new certification ISO 27701 :2019 also known
                     as the Privacy Information Management 
                    System or PIMS. Earlier the ISO 27701 was known as ISO 27552. </p>
                    <p> It is an extention certification on top of the ISO 27001.</p>
                    ...
                    <div className="d-flex align-items-center mb-5 mt-3">
                       ...
                       <Link href="/" >
                            <a className="btn cm-links ">
                                More on our SOC Reporting Services. <FaAngleRight/>
                            </a>
                        </Link>
                    </div>

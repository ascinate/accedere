                                            ...
                                            <div className='col'>
                                                <div className='comon-div1-links'>
                                                    ...
                                                    <ul className='list-unstyled '>
                                                        ...
                                                        <li>
                                                        <Link href='/services/soc2privacy' > 
                                                            <span className="nav-link">SOC Reports for Privacy</span>
                                                        </Link>
                                                        </li>
                                                        <li>
                                                        <Link href='/services/soc4cyber' > 
